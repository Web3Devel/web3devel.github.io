...
#
#   $ python Figure20_08PointLightSpheresSmallRadius.py
#
...
print('Self-test diagnostics for Figure20_08PointLightSpheresSmallRadius.py:')
...
print("python Figure20_08PointLightSpheresSmallRadius.py load and self-test diagnostics complete.")
