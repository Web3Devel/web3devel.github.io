...
#
#   $ python Figure15_11ExtrudedPlaygroundSlide.py
#
...
print('Self-test diagnostics for Figure15_11ExtrudedPlaygroundSlide.py:')
...
print("python Figure15_11ExtrudedPlaygroundSlide.py load and self-test diagnostics complete.")
