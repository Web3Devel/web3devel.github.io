...
#
#   $ python Figure12_3TempleOfInlinedArches.py
#
...
print('Self-test diagnostics for Figure12_3TempleOfInlinedArches.py:')
...
print("python Figure12_3TempleOfInlinedArches.py load and self-test diagnostics complete.")
