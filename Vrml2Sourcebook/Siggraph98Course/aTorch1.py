...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='aTorch1.x3d',name='title'),
    meta(content='Torch with animated flames (high detail): this file creates a torch with animated flames created using the Flames prototype node defined by an EXTERNPROTO.',name='description'),
    ...
    meta(content='originals/aTorch1.wrl',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/aTorch1.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(info=["Copyright (c) 1997, David R. Nadeau"],title='Torch with animated flames (high detail)'),
...
print('Self-test diagnostics for aTorch1.py:')
...
print("python aTorch1.py load and self-test diagnostics complete.")
