...
#
#   $ python Figure25_09TwoDungeonRoomsWithLODHiding.py
#
...
print('Self-test diagnostics for Figure25_09TwoDungeonRoomsWithLODHiding.py:')
...
print("python Figure25_09TwoDungeonRoomsWithLODHiding.py load and self-test diagnostics complete.")
