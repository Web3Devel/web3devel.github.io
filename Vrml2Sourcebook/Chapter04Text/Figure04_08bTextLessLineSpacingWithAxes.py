...
#
#   $ python Figure04_08bTextLessLineSpacingWithAxes.py
#
...
print('Self-test diagnostics for Figure04_08bTextLessLineSpacingWithAxes.py:')
...
print("python Figure04_08bTextLessLineSpacingWithAxes.py load and self-test diagnostics complete.")
