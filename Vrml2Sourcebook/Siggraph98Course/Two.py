...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    ...
    meta(content='Tumbling Cylinders: this world builds a batch of perpetually tumbling cylinders.',name='description'),
    ...
    meta(content='originals/two.wrl',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/Two.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(info=["Copyright (c) 1998, David R. Nadeau"],title='Tumbling Cylinders'),
      ...
      fieldValue(name='children',
        ...
        Shape(DEF='Block',
          appearance=Appearance(
            material=Material(),
            texture=ImageTexture(url=["fire.jpg","https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/fire.jpg"])),
