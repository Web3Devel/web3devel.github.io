...
#
#   $ python Figure13_14VaultedCeilingPieceCreased.py
#
...
print('Self-test diagnostics for Figure13_14VaultedCeilingPieceCreased.py:')
...
print("python Figure13_14VaultedCeilingPieceCreased.py load and self-test diagnostics complete.")
