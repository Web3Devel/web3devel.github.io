...
#
#   $ python Figure20_12TwoDirectionalLightsAimingLeftRightThroughSpheres.py
#
...
print('Self-test diagnostics for Figure20_12TwoDirectionalLightsAimingLeftRightThroughSpheres.py:')
...
print("python Figure20_12TwoDirectionalLightsAimingLeftRightThroughSpheres.py load and self-test diagnostics complete.")
