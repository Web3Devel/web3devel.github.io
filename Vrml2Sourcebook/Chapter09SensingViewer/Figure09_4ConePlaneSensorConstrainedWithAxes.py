...
#
#   $ python Figure09_4ConePlaneSensorConstrainedWithAxes.py
#
...
print('Self-test diagnostics for Figure09_4ConePlaneSensorConstrainedWithAxes.py:')
...
print("python Figure09_4ConePlaneSensorConstrainedWithAxes.py load and self-test diagnostics complete.")
