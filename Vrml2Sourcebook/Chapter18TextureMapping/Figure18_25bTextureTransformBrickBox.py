...
#
#   $ python Figure18_25bTextureTransformBrickBox.py
#
...
print('Self-test diagnostics for Figure18_25bTextureTransformBrickBox.py:')
...
print("python Figure18_25bTextureTransformBrickBox.py load and self-test diagnostics complete.")
