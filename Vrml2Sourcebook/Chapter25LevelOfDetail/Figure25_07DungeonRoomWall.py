...
#
#   $ python Figure25_07DungeonRoomWall.py
#
...
print('Self-test diagnostics for Figure25_07DungeonRoomWall.py:')
...
print("python Figure25_07DungeonRoomWall.py load and self-test diagnostics complete.")
