...
newModel=X3D(profile='Interchange',version='3.3',
  ...
  Scene=Scene(
      ...
      Transform(translation=(-2.0,-1.0,0.0),
        ...
        Shape(DEF='Column',
          appearance=Appearance(DEF='White',
            material=Material(),),
          geometry=Cylinder(bottom=False,height=6.0,radius=0.3,top=False))]),
      Transform(translation=(2.0,-1.0,0.0),
        children=[
        Shape(USE='Column')]),
    ...
    Transform(translation=(0.0,-4.125,0.0),
      ...
      Shape(
        appearance=Appearance(USE='White'),
        geometry=Cylinder(bottom=False,height=0.25,radius=3.0))]),
...
print('Self-test diagnostics for Arches.py:')
...
print("python Arches.py load and self-test diagnostics complete.")
