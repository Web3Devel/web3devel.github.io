...
#
#   $ python Figure08_5AnimatingScale.py
#
...
print('Self-test diagnostics for Figure08_5AnimatingScale.py:')
...
print("python Figure08_5AnimatingScale.py load and self-test diagnostics complete.")
