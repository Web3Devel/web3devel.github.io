...
#
#   $ python Figure09_2SpinningCubeTouchSensorClicked.py
#
...
print('Self-test diagnostics for Figure09_2SpinningCubeTouchSensorClicked.py:')
...
print("python Figure09_2SpinningCubeTouchSensorClicked.py load and self-test diagnostics complete.")
