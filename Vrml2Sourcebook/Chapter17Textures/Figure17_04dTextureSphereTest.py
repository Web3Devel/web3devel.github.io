...
#
#   $ python Figure17_04dTextureSphereTest.py
#
...
print('Self-test diagnostics for Figure17_04dTextureSphereTest.py:')
...
print("python Figure17_04dTextureSphereTest.py load and self-test diagnostics complete.")
