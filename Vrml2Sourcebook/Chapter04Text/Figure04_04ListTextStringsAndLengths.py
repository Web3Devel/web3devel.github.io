...
#
#   $ python Figure04_04ListTextStringsAndLengths.py
#
  ...
  Scene=Scene(
    ...
    Shape(
      ...
      appearance=Appearance(
        material=Material(diffuseColor=(.2,.8,.8))),
...
print('Self-test diagnostics for Figure04_04ListTextStringsAndLengths.py:')
...
print("python Figure04_04ListTextStringsAndLengths.py load and self-test diagnostics complete.")
