...
#
#   $ python Figure13_17bMorphingCubeLineSet.py
#
  ...
  Scene=Scene(
    ...
    Group(
      ...
      Shape(
        ...
        geometry=IndexedLineSet(coordIndex=[0,1,2,3,0,-1,7,6,5,4,7,-1,0,4,5,1,0,-1,1,5,6,2,1,-1,2,6,7,3,2,-1,3,7,4,0,3,-1],
...
print('Self-test diagnostics for Figure13_17bMorphingCubeLineSet.py:')
...
print("python Figure13_17bMorphingCubeLineSet.py load and self-test diagnostics complete.")
