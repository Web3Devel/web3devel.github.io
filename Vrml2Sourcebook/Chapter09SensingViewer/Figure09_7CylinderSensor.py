...
#
#   $ python Figure09_7CylinderSensor.py
#
...
print('Self-test diagnostics for Figure09_7CylinderSensor.py:')
...
print("python Figure09_7CylinderSensor.py load and self-test diagnostics complete.")
