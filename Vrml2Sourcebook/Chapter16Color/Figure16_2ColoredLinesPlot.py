...
#
#   $ python Figure16_2ColoredLinesPlot.py
#
...
print('Self-test diagnostics for Figure16_2ColoredLinesPlot.py:')
...
print("python Figure16_2ColoredLinesPlot.py load and self-test diagnostics complete.")
