...
#
#   $ python Figure17_13SimplePixelTexture.py
#
...
print('Self-test diagnostics for Figure17_13SimplePixelTexture.py:')
...
print("python Figure17_13SimplePixelTexture.py load and self-test diagnostics complete.")
