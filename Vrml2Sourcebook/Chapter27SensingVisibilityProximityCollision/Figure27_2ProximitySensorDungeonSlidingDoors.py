...
#
#   $ python Figure27_2ProximitySensorDungeonSlidingDoors.py
#
...
print('Self-test diagnostics for Figure27_2ProximitySensorDungeonSlidingDoors.py:')
...
print("python Figure27_2ProximitySensorDungeonSlidingDoors.py load and self-test diagnostics complete.")
