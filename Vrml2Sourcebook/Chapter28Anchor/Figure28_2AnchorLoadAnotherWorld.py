...
#
#   $ python Figure28_2AnchorLoadAnotherWorld.py
#
...
print('Self-test diagnostics for Figure28_2AnchorLoadAnotherWorld.py:')
...
print("python Figure28_2AnchorLoadAnotherWorld.py load and self-test diagnostics complete.")
