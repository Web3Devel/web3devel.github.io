...
#
#   $ python Figure25_06DungeonRoomFloor.py
#
...
print('Self-test diagnostics for Figure25_06DungeonRoomFloor.py:')
...
print("python Figure25_06DungeonRoomFloor.py load and self-test diagnostics complete.")
