...
#
#   $ python Figure18_24TextureCoordinateRotatedGrillworkFence.py
#
    ...
    Group(
      ...
      Shape(
        appearance=Appearance(
          ...
          textureTransform=TextureTransform(center=(0.5,0.5),rotation=0.785,scale=(32,8))),
...
print('Self-test diagnostics for Figure18_24TextureCoordinateRotatedGrillworkFence.py:')
...
print("python Figure18_24TextureCoordinateRotatedGrillworkFence.py load and self-test diagnostics complete.")
