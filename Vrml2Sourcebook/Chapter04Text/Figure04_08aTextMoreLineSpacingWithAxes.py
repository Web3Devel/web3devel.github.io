...
#
#   $ python Figure04_08aTextMoreLineSpacingWithAxes.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure04_08aTextMoreLineSpacingWithAxes.x3d',name='title'),
    ...
    meta(content='Text with more-than-default spacing between lines, with coordinate axes superimposed to show X3D/VRML directions. Compare with Figure 4.8b.',name='description'),
    meta(content='Figure04_08bTextLessLineSpacingWithAxes.x3d',name='reference'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter04Text/Figure04_08aTextMoreLineSpacingWithAxes.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure04_08aTextMoreLineSpacingWithAxes.x3d'),
    Shape(
...
print('Self-test diagnostics for Figure04_08aTextMoreLineSpacingWithAxes.py:')
...
print("python Figure04_08aTextMoreLineSpacingWithAxes.py load and self-test diagnostics complete.")
