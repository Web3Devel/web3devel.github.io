...
#
#   $ python Figure04_11TextOverstrikeFont.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure04_11TextOverstrikeFont.x3d',name='title'),
    ...
    meta(content='Show overstrike, using DEF and USE to share font properties.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter04Text/Figure04_11TextOverstrikeFont.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure04_11TextOverstrikeFont.x3d'),
...
print('Self-test diagnostics for Figure04_11TextOverstrikeFont.py:')
...
print("python Figure04_11TextOverstrikeFont.py load and self-test diagnostics complete.")
