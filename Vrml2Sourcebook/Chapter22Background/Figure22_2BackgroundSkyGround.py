...
#
#   $ python Figure22_2BackgroundSkyGround.py
#
...
print('Self-test diagnostics for Figure22_2BackgroundSkyGround.py:')
...
print("python Figure22_2BackgroundSkyGround.py load and self-test diagnostics complete.")
