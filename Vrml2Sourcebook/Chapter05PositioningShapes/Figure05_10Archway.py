...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='Figure05_10Archway.x3d',name='title'),
    ...
    meta(content='Building an archway using multiple, translated coordinate systems.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter05PositioningShapes/Figure05_10Archway.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure05_10Archway.x3d'),
...
print('Self-test diagnostics for Figure05_10Archway.py:')
...
print("python Figure05_10Archway.py load and self-test diagnostics complete.")
