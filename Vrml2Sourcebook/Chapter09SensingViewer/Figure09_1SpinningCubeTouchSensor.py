...
#
#   $ python Figure09_1SpinningCubeTouchSensor.py
#
...
print('Self-test diagnostics for Figure09_1SpinningCubeTouchSensor.py:')
...
print("python Figure09_1SpinningCubeTouchSensor.py load and self-test diagnostics complete.")
