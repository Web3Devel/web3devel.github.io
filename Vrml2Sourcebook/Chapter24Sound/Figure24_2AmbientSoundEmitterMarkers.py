...
#
#   $ python Figure24_2AmbientSoundEmitterMarkers.py
#
...
print('Self-test diagnostics for Figure24_2AmbientSoundEmitterMarkers.py:')
...
print("python Figure24_2AmbientSoundEmitterMarkers.py load and self-test diagnostics complete.")
