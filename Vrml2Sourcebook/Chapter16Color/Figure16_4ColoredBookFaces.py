...
#
#   $ python Figure16_4ColoredBookFaces.py
#
...
print('Self-test diagnostics for Figure16_4ColoredBookFaces.py:')
...
print("python Figure16_4ColoredBookFaces.py load and self-test diagnostics complete.")
