...
#
#   $ python Figure07_10SimpleSpaceship.py
#
...
print('Self-test diagnostics for Figure07_10SimpleSpaceship.py:')
...
print("python Figure07_10SimpleSpaceship.py load and self-test diagnostics complete.")
