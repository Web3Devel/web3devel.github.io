...
#
#   $ python Figure18_20bTextureCoordinatePizzaSlice.py
#
...
print('Self-test diagnostics for Figure18_20bTextureCoordinatePizzaSlice.py:')
...
print("python Figure18_20bTextureCoordinatePizzaSlice.py load and self-test diagnostics complete.")
