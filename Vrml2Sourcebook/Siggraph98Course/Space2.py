  ...
  Scene=Scene(
    ...
    Transform(DEF='LeftWing',rotation=(0.0,1.0,0.0,0.52),scale=(0.4,0.035,1.5),translation=(0.0,0.0,-0.9),
      ...
      Shape(DEF='WingSphere',
        appearance=Appearance(
          material=Material(diffuseColor=(0.7,0.7,1.0),shininess=0.1,specularColor=(1.0,1.0,1.0))),
        geometry=Sphere(),)]),
    ...
    Transform(DEF='Fuselage',scale=(2.0,0.2,0.5),
      ...
      Shape(DEF='FuselageSphere',
        appearance=Appearance(
          material=Material(diffuseColor=(0.5,0.5,1.0),shininess=0.1,specularColor=(0.4,0.7,1.0))),
        geometry=Sphere(),)]),
    Transform(scale=(0.6,0.4,0.375),
      children=[
      Shape(
        appearance=Appearance(
          material=Material(ambientIntensity=0.5,diffuseColor=(0.7,0.5,1.0),shininess=0.5,specularColor=(1.0,0.0,0.3))),
        geometry=Sphere(),)]),
