...
#
#   $ python Figure23_2bLinearFogVisibility40.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure23_2bLinearFogVisibility40.x3d',name='title'),
    ...
    meta(content='A linear-fog world with a visibility range of 40m. Compare Figures 23.2a, 2b, 2c and 2d.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter23Fog/Figure23_2bLinearFogVisibility40.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure23_2bLinearFogVisibility40.x3d'),
...
print('Self-test diagnostics for Figure23_2bLinearFogVisibility40.py:')
...
print("python Figure23_2bLinearFogVisibility40.py load and self-test diagnostics complete.")
