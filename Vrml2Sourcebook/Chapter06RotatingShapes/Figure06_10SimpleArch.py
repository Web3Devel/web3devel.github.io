...
#
#   $ python Figure06_10SimpleArch.py
#
...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='Figure06_10SimpleArch.x3d',name='title'),
    meta(content='Figure 6.10, The VRML 2.0 Sourcebook, Copyright [1997] By Andrea L. Ames, David R. Nadeau, and John L. Moreland',name='creator'),
    meta(content='http://www.wiley.com/legacy/compbooks/vrml2sbk/ch06/06fig10.htm',name='reference'),
    meta(content='Don Brutzman',name='transcriber'),
    meta(content='8 October 2000',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='An archway with pieces of the roof built within translated, rotated coordinate systems. Also see Figures 6.10, 7.11 and 12.1 for comparison.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter06RotatingShapes/Figure06_10SimpleArch.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    #  Note rotation of viewpoint is relative to initial default viewing direction along -Z axis 
    children=[
    WorldInfo(title='Figure06_10SimpleArch.x3d'),
    Viewpoint(description='View arch from position 0 6 16, looking downward.',orientation=(1,0,0,-0.2),position=(0,6,16)),
    Group(
      children=[
      Shape(
...
print('Self-test diagnostics for Figure06_10SimpleArch.py:')
...
print("python Figure06_10SimpleArch.py load and self-test diagnostics complete.")
