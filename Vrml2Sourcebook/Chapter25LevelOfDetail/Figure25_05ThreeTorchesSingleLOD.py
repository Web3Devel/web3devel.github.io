...
#
#   $ python Figure25_05ThreeTorchesSingleLOD.py
#
...
print('Self-test diagnostics for Figure25_05ThreeTorchesSingleLOD.py:')
...
print("python Figure25_05ThreeTorchesSingleLOD.py load and self-test diagnostics complete.")
