...
#
#   $ python Figure20_11bDirectionalLightAimingUpperRightThroughSpheres.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure20_11bDirectionalLightAimingUpperRightThroughSpheres.x3d',name='title'),
    meta(content='Figure 20.11b, The VRML 2.0 Sourcebook, Copyright [1997] By Andrea L. Ames, David R. Nadeau, and John L. Moreland',name='creator'),
    meta(content='http://www.wiley.com/legacy/compbooks/vrml2sbk/ch20/20fig11b.htm',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter20Lighting/Figure20_11bDirectionalLightAimingUpperRightThroughSpheres.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure20_11bDirectionalLightAimingUpperRightThroughSpheres.x3d'),
    ...
    Group(
      children=[
      DirectionalLight(direction=(0.7071,0.7071,0)),
...
print('Self-test diagnostics for Figure20_11bDirectionalLightAimingUpperRightThroughSpheres.py:')
...
print("python Figure20_11bDirectionalLightAimingUpperRightThroughSpheres.py load and self-test diagnostics complete.")
