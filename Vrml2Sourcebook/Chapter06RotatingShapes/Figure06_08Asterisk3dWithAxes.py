...
#
#   $ python Figure06_08Asterisk3dWithAxes.py
#
...
print('Self-test diagnostics for Figure06_08Asterisk3dWithAxes.py:')
...
print("python Figure06_08Asterisk3dWithAxes.py load and self-test diagnostics complete.")
