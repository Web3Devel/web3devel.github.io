...
#
#   $ python Figure14_6ElevationGridMedallion.py
#
...
print('Self-test diagnostics for Figure14_6ElevationGridMedallion.py:')
...
print("python Figure14_6ElevationGridMedallion.py load and self-test diagnostics complete.")
