...
#
#   $ python Figure13_11IndexedLineSetBoxWireframe.py
#
...
print('Self-test diagnostics for Figure13_11IndexedLineSetBoxWireframe.py:')
...
print("python Figure13_11IndexedLineSetBoxWireframe.py load and self-test diagnostics complete.")
