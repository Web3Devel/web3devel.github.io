...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='DirectionalLight.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/DirectionalLight.x3d',name='identifier'),
...
print ("python x3d.py load successful for DirectionalLight.py")
