...
#
#   $ python Figure23_1FogTestWorld.py
#
      ...
      Group(DEF='ColumnPair',
        ...
        Transform(translation=(-4,3,0),
          ...
          Shape(DEF='Column',
            ...
            appearance=Appearance(
              material=Material(diffuseColor=(1,0.8,0.5))))]),
        Transform(translation=(4,3,0),
          children=[
          Shape(USE='Column')])]),
...
print('Self-test diagnostics for Figure23_1FogTestWorld.py:')
...
print("python Figure23_1FogTestWorld.py load and self-test diagnostics complete.")
