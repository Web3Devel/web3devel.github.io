...
#
#   $ python Figure16_3ColoredLinesStarburstWithAxes.py
#
...
print('Self-test diagnostics for Figure16_3ColoredLinesStarburstWithAxes.py:')
...
print("python Figure16_3ColoredLinesStarburstWithAxes.py load and self-test diagnostics complete.")
