...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='Ceiling.x3d',name='title'),
    meta(content='Gothic vaulted ceiling: this file combines together four vaulted ceiling pieces to create a vaulted ceiling, such as might be found in gothic architecture.',name='description'),
    ...
    meta(content='originals/ceiling.wrl',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/Ceiling.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Ceiling.x3d'),
...
print('Self-test diagnostics for Ceiling.py:')
...
print("python Ceiling.py load and self-test diagnostics complete.")
