...
#
#   $ python Figure17_11bGreyTextureGreenMaterialStripedCylinder.py
#
...
print('Self-test diagnostics for Figure17_11bGreyTextureGreenMaterialStripedCylinder.py:')
...
print("python Figure17_11bGreyTextureGreenMaterialStripedCylinder.py load and self-test diagnostics complete.")
