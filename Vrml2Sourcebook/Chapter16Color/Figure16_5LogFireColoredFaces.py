...
#
#   $ python Figure16_5LogFireColoredFaces.py
#
...
print('Self-test diagnostics for Figure16_5LogFireColoredFaces.py:')
...
print("python Figure16_5LogFireColoredFaces.py load and self-test diagnostics complete.")
