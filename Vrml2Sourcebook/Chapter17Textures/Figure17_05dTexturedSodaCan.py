...
#
#   $ python Figure17_05dTexturedSodaCan.py
#
...
print('Self-test diagnostics for Figure17_05dTexturedSodaCan.py:')
...
print("python Figure17_05dTexturedSodaCan.py load and self-test diagnostics complete.")
