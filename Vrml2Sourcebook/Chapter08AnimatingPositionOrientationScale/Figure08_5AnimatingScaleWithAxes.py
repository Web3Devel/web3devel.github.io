...
#
#   $ python Figure08_5AnimatingScaleWithAxes.py
#
...
print('Self-test diagnostics for Figure08_5AnimatingScaleWithAxes.py:')
...
print("python Figure08_5AnimatingScaleWithAxes.py load and self-test diagnostics complete.")
