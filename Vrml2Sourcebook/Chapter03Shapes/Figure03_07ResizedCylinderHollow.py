...
#
#   $ python Figure03_07ResizedCylinderHollow.py
#
...
print('Self-test diagnostics for Figure03_07ResizedCylinderHollow.py:')
...
print("python Figure03_07ResizedCylinderHollow.py load and self-test diagnostics complete.")
