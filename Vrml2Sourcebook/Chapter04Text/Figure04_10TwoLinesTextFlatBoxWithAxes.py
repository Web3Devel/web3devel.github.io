...
#
#   $ python Figure04_10TwoLinesTextFlatBoxWithAxes.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure04_10TwoLinesTextFlatBoxWithAxes.x3d',name='title'),
    ...
    meta(content='Two lines of text with a flat box between them, with coordinate axes superimposed to show X3D/VRML directions',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter04Text/Figure04_10TwoLinesTextFlatBoxWithAxes.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure04_10TwoLinesTextFlatBoxWithAxes.x3d'),
    Shape(
...
print('Self-test diagnostics for Figure04_10TwoLinesTextFlatBoxWithAxes.py:')
...
print("python Figure04_10TwoLinesTextFlatBoxWithAxes.py load and self-test diagnostics complete.")
