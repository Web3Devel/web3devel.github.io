...
#
#   $ python Figure10_06PulsatingSpaceStation.py
#
...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='Figure10_06PulsatingSpaceStation.x3d',name='title'),
    ...
    meta(content='A multicolored space station where color of the center sphere animates from red, to green, to blue, and back to red by utilizing ColorInterpolator outputs. Also see Figure03_10SpaceStation.x3d and Figure010.05MultiColoredSpaceStation.x3d',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter10Materials/Figure10_06PulsatingSpaceStation.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure10_06PulsatingSpaceStation.x3d'),
...
print('Self-test diagnostics for Figure10_06PulsatingSpaceStation.py:')
...
print("python Figure10_06PulsatingSpaceStation.py load and self-test diagnostics complete.")
