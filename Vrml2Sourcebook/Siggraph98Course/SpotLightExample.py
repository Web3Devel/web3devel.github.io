...
newModel=X3D(profile='Immersive',version='3.3',
  head=head(
    children=[
    meta(content='SpotLightExample.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/SpotLightExample.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='SpotLightExample.x3d'),
...
print('Self-test diagnostics for SpotLightExample.py:')
...
print("python SpotLightExample.py load and self-test diagnostics complete.")
