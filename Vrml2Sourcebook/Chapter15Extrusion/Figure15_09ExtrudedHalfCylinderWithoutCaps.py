...
#
#   $ python Figure15_09ExtrudedHalfCylinderWithoutCaps.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure15_09ExtrudedHalfCylinderWithoutCaps.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter15Extrusion/Figure15_09ExtrudedHalfCylinderWithoutCaps.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    #  First position and rotate viewpoint into positive-X-Y-Z octant 
    children=[
    WorldInfo(title='Figure15_09ExtrudedHalfCylinderWithoutCaps.x3d'),
...
print('Self-test diagnostics for Figure15_09ExtrudedHalfCylinderWithoutCaps.py:')
...
print("python Figure15_09ExtrudedHalfCylinderWithoutCaps.py load and self-test diagnostics complete.")
