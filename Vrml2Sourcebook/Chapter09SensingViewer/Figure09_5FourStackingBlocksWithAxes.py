...
#
#   $ python Figure09_5FourStackingBlocksWithAxes.py
#
...
print('Self-test diagnostics for Figure09_5FourStackingBlocksWithAxes.py:')
...
print("python Figure09_5FourStackingBlocksWithAxes.py load and self-test diagnostics complete.")
