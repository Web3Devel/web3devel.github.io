...
#
#   $ python Figure25_03TorchLowDetail.py
#
...
print('Self-test diagnostics for Figure25_03TorchLowDetail.py:')
...
print("python Figure25_03TorchLowDetail.py load and self-test diagnostics complete.")
