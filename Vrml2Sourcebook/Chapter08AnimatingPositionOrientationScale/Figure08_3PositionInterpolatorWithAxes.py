...
#
#   $ python Figure08_3PositionInterpolatorWithAxes.py
#
...
print('Self-test diagnostics for Figure08_3PositionInterpolatorWithAxes.py:')
...
print("python Figure08_3PositionInterpolatorWithAxes.py load and self-test diagnostics complete.")
