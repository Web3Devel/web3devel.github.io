...
#
#   $ python Figure04_10TwoLinesTextFlatBox.py
#
...
print('Self-test diagnostics for Figure04_10TwoLinesTextFlatBox.py:')
...
print("python Figure04_10TwoLinesTextFlatBox.py load and self-test diagnostics complete.")
