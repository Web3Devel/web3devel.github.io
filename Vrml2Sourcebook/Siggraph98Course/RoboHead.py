...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='RoboHead.x3d',name='title'),
    meta(content='Robot Billboard head for RoboBill.',name='description'),
    ...
    meta(content='originals/robohead.wrl',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/RoboHead.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='RoboHead.x3d'),
    Shape(
    ...
    Transform(translation=(0.1,0.15,0.38),
      ...
      Shape(DEF='Eye',
        appearance=Appearance(
          material=Material(diffuseColor=(0.4,1.0,0.0),emissiveColor=(0.6,0.0,0.0))),
      ...
      Transform(translation=(0.0,0.58,0.0),
        ...
        Shape(
          appearance=Appearance(DEF='RobotGlow',
            material=Material(diffuseColor=(0.0,1.0,0.0),emissiveColor=(1.0,0.0,0.0))),
...
print('Self-test diagnostics for RoboHead.py:')
...
print("python RoboHead.py load and self-test diagnostics complete.")
