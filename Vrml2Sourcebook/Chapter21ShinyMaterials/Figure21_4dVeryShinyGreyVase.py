...
#
#   $ python Figure21_4dVeryShinyGreyVase.py
#
...
print('Self-test diagnostics for Figure21_4dVeryShinyGreyVase.py:')
...
print("python Figure21_4dVeryShinyGreyVase.py load and self-test diagnostics complete.")
