...
#
#   $ python Figure08_4OrientationInterpolator.py
#
...
print('Self-test diagnostics for Figure08_4OrientationInterpolator.py:')
...
print("python Figure08_4OrientationInterpolator.py load and self-test diagnostics complete.")
