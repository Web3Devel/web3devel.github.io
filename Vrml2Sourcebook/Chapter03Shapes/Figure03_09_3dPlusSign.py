...
#
#   $ python Figure03_09_3dPlusSign.py
#
...
print('Self-test diagnostics for Figure03_09_3dPlusSign.py:')
...
print("python Figure03_09_3dPlusSign.py load and self-test diagnostics complete.")
