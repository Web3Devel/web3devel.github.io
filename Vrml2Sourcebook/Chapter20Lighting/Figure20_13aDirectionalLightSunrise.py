...
#
#   $ python Figure20_13aDirectionalLightSunrise.py
#
...
print('Self-test diagnostics for Figure20_13aDirectionalLightSunrise.py:')
...
print("python Figure20_13aDirectionalLightSunrise.py load and self-test diagnostics complete.")
