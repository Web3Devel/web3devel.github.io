...
#
#   $ python Figure09_6SphereSensorWithAxes.py
#
...
print('Self-test diagnostics for Figure09_6SphereSensorWithAxes.py:')
...
print("python Figure09_6SphereSensorWithAxes.py load and self-test diagnostics complete.")
