...
#
#   $ python Figure10_08BlinkingSphere.py
#
...
print('Self-test diagnostics for Figure10_08BlinkingSphere.py:')
...
print("python Figure10_08BlinkingSphere.py load and self-test diagnostics complete.")
