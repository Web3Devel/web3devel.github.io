...
#
#   $ python Figure06_07bRotationMinus45zWithAxes.py
#
...
print('Self-test diagnostics for Figure06_07bRotationMinus45zWithAxes.py:')
...
print("python Figure06_07bRotationMinus45zWithAxes.py load and self-test diagnostics complete.")
