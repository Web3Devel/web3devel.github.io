...
#
#   $ python Figure15_13ExtrudedPyramidWithAxes.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure15_13ExtrudedPyramidWithAxes.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter15Extrusion/Figure15_13ExtrudedPyramidWithAxes.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    children=[
    WorldInfo(title='Figure15_13ExtrudedPyramidWithAxes.x3d'),
    Viewpoint(description='Extruded pyramid',orientation=(-0.37796,0.91249,0.15656,0.85225),position=(4,2,4)),
    Shape(
...
print('Self-test diagnostics for Figure15_13ExtrudedPyramidWithAxes.py:')
...
print("python Figure15_13ExtrudedPyramidWithAxes.py load and self-test diagnostics complete.")
