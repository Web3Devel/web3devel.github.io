...
#
#   $ python Figure23_2cLinearFogVisibility30.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure23_2cLinearFogVisibility30.x3d',name='title'),
    ...
    meta(content='http://www.wiley.com/legacy/compbooks/vrml2sbk/ch23/23fig02c.htm',name='reference'),
    meta(content='Don Brutzman',name='translator'),
    meta(content='22 September 2000',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='A linear-fog world with a visibility range of 30m. Compare Figures 23.2a, 2b, 2c and 2d.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter23Fog/Figure23_2cLinearFogVisibility30.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure23_2cLinearFogVisibility30.x3d'),
...
print('Self-test diagnostics for Figure23_2cLinearFogVisibility30.py:')
...
print("python Figure23_2cLinearFogVisibility30.py load and self-test diagnostics complete.")
