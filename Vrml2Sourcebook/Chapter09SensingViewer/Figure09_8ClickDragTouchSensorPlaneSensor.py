...
#
#   $ python Figure09_8ClickDragTouchSensorPlaneSensor.py
#
...
print('Self-test diagnostics for Figure09_8ClickDragTouchSensorPlaneSensor.py:')
...
print("python Figure09_8ClickDragTouchSensorPlaneSensor.py load and self-test diagnostics complete.")
