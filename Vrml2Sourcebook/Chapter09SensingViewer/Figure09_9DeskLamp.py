...
newModel=X3D(profile='Interactive',version='3.0',
  head=head(
    children=[
    meta(content='Figure09_9DeskLamp.x3d',name='title'),
    ...
    meta(content='A desk lamp with arm angles that can be adjusted using nested sensors.',name='description'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter09SensingViewer/Figure09_9DeskLamp.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure09_9DeskLamp.x3d'),
    Viewpoint(description='Desk lamp',position=(0,0.2,1)),
...
print('Self-test diagnostics for Figure09_9DeskLamp.py:')
...
print("python Figure09_9DeskLamp.py load and self-test diagnostics complete.")
