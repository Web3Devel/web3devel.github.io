...
#
#   $ python Figure20_04HeadlightSpheres.py
#
...
print('Self-test diagnostics for Figure20_04HeadlightSpheres.py:')
...
print("python Figure20_04HeadlightSpheres.py load and self-test diagnostics complete.")
