...
#
#   $ python Figure07_07bScaleHalfzWithAxes.py
#
...
print('Self-test diagnostics for Figure07_07bScaleHalfzWithAxes.py:')
...
print("python Figure07_07bScaleHalfzWithAxes.py load and self-test diagnostics complete.")
