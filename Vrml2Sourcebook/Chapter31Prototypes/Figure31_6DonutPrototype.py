...
#
#   $ python Figure31_6DonutPrototype.py
#
...
print('Self-test diagnostics for Figure31_6DonutPrototype.py:')
...
print("python Figure31_6DonutPrototype.py load and self-test diagnostics complete.")
