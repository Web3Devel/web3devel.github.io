...
#
#   $ python Figure20_13cDirectionalLightSunset.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure20_13cDirectionalLightSunset.x3d',name='title'),
    meta(content='Figure 20.13c, The VRML 2.0 Sourcebook, Copyright [1997] By Andrea L. Ames, David R. Nadeau, and John L. Moreland',name='creator'),
    meta(content='http://www.wiley.com/legacy/compbooks/vrml2sbk/ch20/20fig13c.htm',name='reference'),
    meta(content='Don Brutzman',name='translator'),
    meta(content='8 September 2000',name='created'),
    meta(content='20 October 2019',name='modified'),
    meta(content='A DirectionalLight used to simulate the sun at sunset. Compare Figures 20.13a, 13b, 13c, 14.',name='description'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter20Lighting/Figure20_13cDirectionalLightSunset.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Figure20_13cDirectionalLightSunset.x3d'),
    Viewpoint(description='Exit sun, stage left',orientation=(1,0,0,-0.15),position=(0,4,10)),
    ...
    Group(
      children=[
      DirectionalLight(ambientIntensity=0.2,color=(1,0.3,0),direction=(-0.8,-0.2,-0.2)),
...
print('Self-test diagnostics for Figure20_13cDirectionalLightSunset.py:')
...
print("python Figure20_13cDirectionalLightSunset.py load and self-test diagnostics complete.")
