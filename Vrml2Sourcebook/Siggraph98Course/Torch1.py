...
newModel=X3D(profile='Interchange',version='3.3',
  head=head(
    children=[
    meta(content='Torch1.x3d',name='title'),
    meta(content='Medieval torch with high-resolution detail.',name='description'),
    ...
    meta(content='originals/torch1.wrl',name='reference'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Siggraph98Course/Torch1.x3d',name='identifier'),
    meta(content='Vrml97ToX3dNist, http://ovrt.nist.gov/v2_x3d.html',name='generator'),
    meta(content='X3D-Edit, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../license.html',name='license')]),
  Scene=Scene(
    children=[
    WorldInfo(title='Torch1.x3d'),
    Transform(scale=(0.5,0.5,0.5),translation=(0.0,0.0,0.2),
      ...
      Shape(DEF='Bar',
        ...
        geometry=IndexedFaceSet(coordIndex=[0,1,2,3],
          coord=Coordinate(point=[(0.04,0.0,0.38),(0.04,0.35,0.38),(-0.04,0.35,0.38),(-0.04,0.0,0.38)]))),
      ...
      Transform(rotation=(0.0,1.0,0.0,1.571),
        children=[
        Shape(USE='Bar')]),
      Transform(translation=(0.0,-0.35,0.0),
        children=[
        Shape(
          appearance=Appearance(USE='Gray'),
      ...
      Shape(DEF='Flames',
        geometry=IndexedFaceSet(coordIndex=[0,1,2,-1,3,4,5,-1,6,7,8,-1],
          coord=Coordinate(point=[(0.25,0.0,0.0),(0.15,1.0,0.1),(0.05,0.0,0.15),(0.18,0.0,0.05),(0.0,1.2,0.05),(-0.1,0.0,0.05),(-0.0,0.0,0.15),(-0.13,0.8,0.1),(-0.25,0.0,0.0)]),
          color=Color(color=[(1.0,0.0,0.0),(0.9,0.5,0.0),(1.0,0.0,0.0),(0.9,0.3,0.0),(1.0,1.0,0.0),(0.9,0.3,0.0),(0.7,0.1,0.2),(0.9,0.8,0.0),(1.0,0.0,0.0)]))),
      Transform(rotation=(0.0,1.0,0.0,1.57),scale=(0.9,0.9,1.0),
        children=[
        Shape(USE='Flames')]),
      Transform(rotation=(0.0,1.0,0.0,-1.57),scale=(0.9,0.9,1.0),
        children=[
...
print('Self-test diagnostics for Torch1.py:')
...
print("python Torch1.py load and self-test diagnostics complete.")
