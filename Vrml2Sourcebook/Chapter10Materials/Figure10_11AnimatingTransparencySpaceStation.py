...
#
#   $ python Figure10_11AnimatingTransparencySpaceStation.py
#
...
print('Self-test diagnostics for Figure10_11AnimatingTransparencySpaceStation.py:')
...
print("python Figure10_11AnimatingTransparencySpaceStation.py load and self-test diagnostics complete.")
