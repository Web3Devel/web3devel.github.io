...
#
#   $ python Figure13_16VaultedCeiling.py
#
...
print('Self-test diagnostics for Figure13_16VaultedCeiling.py:')
...
print("python Figure13_16VaultedCeiling.py load and self-test diagnostics complete.")
