...
#
#   $ python Figure24_6DirectedAmbientSound.py
#
...
print('Self-test diagnostics for Figure24_6DirectedAmbientSound.py:')
...
print("python Figure24_6DirectedAmbientSound.py load and self-test diagnostics complete.")
