...
#
#   $ python Figure15_12TorusWithAxes.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure15_12TorusWithAxes.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter15Extrusion/Figure15_12TorusWithAxes.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    children=[
    WorldInfo(title='Figure15_12TorusWithAxes.x3d'),
...
print('Self-test diagnostics for Figure15_12TorusWithAxes.py:')
...
print("python Figure15_12TorusWithAxes.py load and self-test diagnostics complete.")
