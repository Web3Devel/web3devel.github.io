...
#
#   $ python Figure10_09ThreeBlinkingShapes.py
#
...
newModel=X3D(profile='Interchange',version='3.0',
  head=head(
    children=[
    meta(content='Figure10_09ThreeBlinkingShapes.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter10Materials/Figure10_09ThreeBlinkingShapes.x3d',name='identifier'),
      ...
      Transform(translation=(-2,0,0),
        ...
        Shape(
          appearance=Appearance(
            material=Material(DEF='BALL_COLOR_1',diffuseColor=(0.4,0.4,0.4))),
          geometry=Box(size=(1.5,1.5,1.5)))]),
      Shape(
        appearance=Appearance(
          material=Material(DEF='BALL_COLOR_2',diffuseColor=(0.4,0.4,0.4))),
        geometry=Sphere(),),
      Transform(translation=(2,0,0),
        children=[
        Shape(
          appearance=Appearance(
            material=Material(DEF='BALL_COLOR_3',diffuseColor=(0.4,0.4,0.4))),
          geometry=Cone(),)]),
...
print('Self-test diagnostics for Figure10_09ThreeBlinkingShapes.py:')
...
print("python Figure10_09ThreeBlinkingShapes.py load and self-test diagnostics complete.")
