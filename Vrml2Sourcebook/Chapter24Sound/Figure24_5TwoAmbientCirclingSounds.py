...
#
#   $ python Figure24_5TwoAmbientCirclingSounds.py
#
...
print('Self-test diagnostics for Figure24_5TwoAmbientCirclingSounds.py:')
...
print("python Figure24_5TwoAmbientCirclingSounds.py load and self-test diagnostics complete.")
