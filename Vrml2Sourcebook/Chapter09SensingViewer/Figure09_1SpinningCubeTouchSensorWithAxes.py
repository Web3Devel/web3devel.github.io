...
#
#   $ python Figure09_1SpinningCubeTouchSensorWithAxes.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure09_1SpinningCubeTouchSensorWithAxes.x3d',name='title'),
    ...
    meta(content='Figure09_2SpinningCubeTouchSensorClickedWithAxes.x3d',name='reference'),
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter09SensingViewer/Figure09_1SpinningCubeTouchSensorWithAxes.x3d',name='identifier'),
    meta(content='X3D-Edit 3.3, https://savage.nps.edu/X3D-Edit',name='generator'),
    meta(content='../../license.html',name='license')]),
  Scene=Scene(
    #  Rotating Cube 
    children=[
    WorldInfo(title='Figure09_1SpinningCubeTouchSensorWithAxes.x3d'),
    Group(
      children=[
...
print('Self-test diagnostics for Figure09_1SpinningCubeTouchSensorWithAxes.py:')
...
print("python Figure09_1SpinningCubeTouchSensorWithAxes.py load and self-test diagnostics complete.")
