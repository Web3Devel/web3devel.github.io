...
#
#   $ python Figure15_17WigglingSnake.py
#
...
print('Self-test diagnostics for Figure15_17WigglingSnake.py:')
...
print("python Figure15_17WigglingSnake.py load and self-test diagnostics complete.")
