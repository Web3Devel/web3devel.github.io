...
#
#   $ python Figure04_08aTextMoreLineSpacing.py
#
...
print('Self-test diagnostics for Figure04_08aTextMoreLineSpacing.py:')
...
print("python Figure04_08aTextMoreLineSpacing.py load and self-test diagnostics complete.")
