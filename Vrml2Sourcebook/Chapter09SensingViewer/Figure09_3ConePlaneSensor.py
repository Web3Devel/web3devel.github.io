...
#
#   $ python Figure09_3ConePlaneSensor.py
#
...
print('Self-test diagnostics for Figure09_3ConePlaneSensor.py:')
...
print("python Figure09_3ConePlaneSensor.py load and self-test diagnostics complete.")
