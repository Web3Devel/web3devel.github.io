...
#
#   $ python Figure31_5WoodAppearanceExternalPrototypes.py
#
...
print('Self-test diagnostics for Figure31_5WoodAppearanceExternalPrototypes.py:')
...
print("python Figure31_5WoodAppearanceExternalPrototypes.py load and self-test diagnostics complete.")
