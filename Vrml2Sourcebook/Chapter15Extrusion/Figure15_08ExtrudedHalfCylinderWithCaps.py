...
#
#   $ python Figure15_08ExtrudedHalfCylinderWithCaps.py
#
...
print('Self-test diagnostics for Figure15_08ExtrudedHalfCylinderWithCaps.py:')
...
print("python Figure15_08ExtrudedHalfCylinderWithCaps.py load and self-test diagnostics complete.")
