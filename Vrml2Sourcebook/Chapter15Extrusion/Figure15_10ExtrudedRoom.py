...
#
#   $ python Figure15_10ExtrudedRoom.py
#
...
newModel=X3D(profile='Immersive',version='3.0',
  head=head(
    children=[
    meta(content='Figure15_10ExtrudedRoom.x3d',name='title'),
    ...
    meta(content='https://www.web3d.org/x3d/content/examples/Vrml2Sourcebook/Chapter15Extrusion/Figure15_10ExtrudedRoom.x3d',name='identifier'),
  ...
  Scene=Scene(
    ...
    children=[
    WorldInfo(title='Figure15_10ExtrudedRoom.x3d'),
...
print('Self-test diagnostics for Figure15_10ExtrudedRoom.py:')
...
print("python Figure15_10ExtrudedRoom.py load and self-test diagnostics complete.")
