...
#
#   $ python Figure20_14DirectionalLightSunAnimated.py
#
...
print('Self-test diagnostics for Figure20_14DirectionalLightSunAnimated.py:')
...
print("python Figure20_14DirectionalLightSunAnimated.py load and self-test diagnostics complete.")
