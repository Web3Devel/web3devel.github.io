...
#
#   $ python Figure25_01TorchHighDetail.py
#
...
print('Self-test diagnostics for Figure25_01TorchHighDetail.py:')
...
print("python Figure25_01TorchHighDetail.py load and self-test diagnostics complete.")
